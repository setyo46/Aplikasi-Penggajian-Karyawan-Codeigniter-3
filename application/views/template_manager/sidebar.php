<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url ('manager/laporangaji')?>">Laporan Gaji</a>
                        <a class="collapse-item" href="<?php echo base_url ('manager/laporankehadiran')?>">Laporan Kehadiran</a>
                        <a class="collapse-item" href="<?php echo base_url ('manager/slipgaji')?>">Slip Gaji</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manager/ubah_password') ?>">
