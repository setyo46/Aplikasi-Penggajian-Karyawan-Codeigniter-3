    ...
    <div class="card mx-auto justify-content-between mb-3" style="width: 35%" >
        ...
        <form>
            ...
            <center>
                ...
                <a href="<?= base_url('admin/laporankehadiran/cetak_laporan_kehadiran?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2"><i class="fas fa-print"></i> Cetak </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Data kehadiran masih kosong, silahkan input kehadiran terlebih dahulu pada bulan dan tahun yang Anda pilih.
      </div>
